...
<head>
    ...
    <title>MARFRA | Pedido Entrega Instalação</title>
                    ...
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-md"> <strong class="font-bold">João Dias</strong>
                             </span> <span class="text-muted text-xs block">Entrega-Instalação<b class="caret"></b></span> </span> </a>
