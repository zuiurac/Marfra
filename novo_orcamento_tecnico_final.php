        ...
        <div class="row">
                ...
                <div class="col-sm-8 text-right">
                  ...
                  <p>
                    ...
                    <br/>
                    <span>
                      <strong>Data da visita:</strong> Março 24, 2014</span>
                  </p>
                </div>
              </div>
            ...
            <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                 <div class="col-lg-12 padding-0 m-b-xs">
                  <button class="btn btn-default" type="submit"><i class="fa fa-download"></i>&nbsp;&nbsp;Deseja importar dados do orçamento?</button>
                </div>
                                                   ...
                                                   <div class="col-lg-12">
                                                      <div class="form-group col-lg-3 padding-0">
                                                        <label class="control-label">Processo</label>
                                                          ...
                                                          <div class="checkbox i-checks col-sm-6">
                                                            <label class="primeiro_produto">
                                                              <div class="icheckbox_square-greenMarfra checked"><input type="checkbox" value="" checked=""></div>
                                                              <i></i> Mecanizado
                                                            </label>
                                                          </div>
                                                          <div class="checkbox i-checks col-sm-6">
                                                            <label>
                                                              <div class="icheckbox_square-greenMarfra"><input type="checkbox" value=""></div>
                                                              <i></i> Automatizado
                                                            </label>
                                                          </div>
                                                      </div>
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <div class="ibox-content">
                                  ...
                                  <div class="ibox-content m-l m-t-lg">
                                    <div class="row">
                                      <div class="col-sm-6 padding-0">
                                        <form role="form">
                                          <div>
                                            <label>
                                              <input type="checkbox" class="i-checks"> A inclusão de dados está 100% concluída? </label>
                                          </div>
                                        </form>
                                      </div>
