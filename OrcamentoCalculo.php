...
<div class="ibox-content">
                <label class="control-label clear m-b-lg m-t-sm"><strong>Clique no nome do arquivo para editar seu nome</strong></label>
                ...
                <div class="form-group col-md-1 padding-0 download_projetista">
                  <div class="btn-group">
                    ...
                    </label><div class="hr-line-dashed clear_both visibility_none"></div>
                  </div>
                  <div class="btn-group">
                    <label title="Upload image file" for="inputImage" class="download_wda btn btn-primary">
                      <input type="file" accept="" name="file" id="inputImage" class="hide">
                      <i class="fa fa-download"></i>&nbsp;&nbsp;Download
                    </label><div class="visibility_none hr-line-dashed clear_both"></div>
                  </div>
                <div class="btn-group">
                    <label title="Upload image file" for="inputImage" class="download_wda btn btn-primary">
                      <input type="file" accept="" name="file" id="inputImage" class="hide">
